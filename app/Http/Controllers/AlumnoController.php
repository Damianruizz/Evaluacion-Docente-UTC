...
class AlumnoController extends Controller
{
    ...
    public function survey($id_profesor, $carrera)
    {
        if (Session::has('alumno')) {
            $profesor = ProfesorModel::find($id_profesor);
            $alumno_sesion = Session::get('alumno');
            $alumno = AlumnoModel::find($alumno_sesion);
    ...
    public function home($id){
        ...
        if (Session::has('alumno')) {
            ...
            if ($alumno_sesion = Session::get('alumno') == $id){
               ...
               return View::make("alumno/helloa", array("alumno" => $alumno, "alumno_sesion" => $alumno_sesion, "profesores_data" => $maestros, "grupo" => $grupo, "carrera" => $carrera, "turno" => $turno));
            } else {
